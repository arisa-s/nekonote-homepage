  ...
  return (
    <div className="max-w-8xl space-y-8">
      <p className="text-xl md:text-3xl leading-normal font-accent">
        Inspired by the Japanese saying “Nekonote mo karitai,” which means I'd
        even want to borrow a cat's hand when overwhelmed with busyness,
        Nekonote LLC aims to ease the small pains of daily activities and enrich
        life with our software solutions.
      </p>
